...
from zerver.views.llm_features import get_unread_message_recap, improve_topic_title
...
v1_api_and_json_patterns = [
    ...
    rest_path(
        "topics/improve-title",
        POST=(improve_topic_title, {"intentionally_undocumented"}),
    ),
