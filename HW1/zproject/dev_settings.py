...
# Groq serves an OpenAI-compatible API, so the stock OpenAI client works
# against it.  Note that the model name here is Groq's own model ID; the
# "groq/" prefix used by LiteLLM is not understood by this endpoint.
TOPIC_SUMMARIZATION_MODEL = "openai/gpt-oss-120b"
TOPIC_SUMMARIZATION_API_BASE = "https://api.groq.com/openai/v1"
# Defaults based on groq's pricing for GPT-OSS 120B.
# https://groq.com/pricing/
OUTPUT_COST_PER_GIGATOKEN = 750
